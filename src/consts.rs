...
pub const BOARD_AMOUNT_ROWS: usize = 20;
pub const BOARD_UPPER_LEFT: (i32, i32) = (200, 50);
pub const HOLD_PIECE_UPPERLEFT: (isize,isize) = (BOARD_UPPER_LEFT.0 as isize - 140,BOARD_UPPER_LEFT.1 as isize + 50);
